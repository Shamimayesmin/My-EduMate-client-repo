		...
		<div>
			<div className="w-full text-white mx-auto mt-10 bg-slate-500 max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
				...
				<div className="flex justify-center space-x-4">
					...
					<button aria-label="Log in with Twitter" className="p-3 rounded-sm hover:bg-purple-400">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 32 32"
							className="w-5 h-5 fill-current"
					...
					<button aria-label="Log in with GitHub" className="p-3 rounded-sm hover:bg-purple-400">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 32 32"
							className="w-5 h-5 fill-current"
