...
const Blog = () => {
	return (
		<div>
			<section className="py-6 bg-violet-200 sm:py-12 dark:bg-gray-800 dark:text-gray-100">
				<div className="container p-6 mx-auto space-y-8">
					...
					<div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
						<article className="flex flex-col bg-slate-200 dark:bg-gray-900">
							<a
						...
						<article className="flex flex-col bg-slate-100 dark:bg-gray-900">
							<a
								rel="noopener noreferrer"
								href="#"
								aria-label="Te nulla oportere reprimique his dolorum"
